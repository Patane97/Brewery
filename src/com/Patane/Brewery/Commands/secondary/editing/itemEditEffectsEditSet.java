...
@CommandInfo(
	name = "edit effects edit <effect name> set",
	description = "Sets something in an Effect that is attached to a Brewery Item.",
	usage = "/br edit effects edit <effect name> set [something] ..."
)
...
public class itemEditEffectsEditSet extends itemEditEffectsEdit {
	...
	public boolean execute(CommandSender sender, String[] args, Object... objects) {
		...
		CommandHandler.grabInstance().handleCommand(sender, child, args, objects[0]);
		return true;
	}
}
